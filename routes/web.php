...
// Route::get('charts',[ApiDashboardController::class,'saleChart']);



Route::get('make', function () {
    // $webproduct = Webproduct::all();
    // $webproduct->category()->where('product_id', 7)->get();
  
   return $posts = Webproduct::select('name',"id")->where('category_id', 7)->get();
...
Route::get('webpage/{id}',[ApiWebproductController::class,'categoryFilter']);
